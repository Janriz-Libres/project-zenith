...
class EditWorkspaceDialog extends StatelessWidget {
                ...
                child: Align(
                  ...
                  child: SubmitButton(
                    ...
                    func: () async {
                      ...
                      if(workspaceDescriptionController.text.isEmpty) {
                        description = workspace.description;
                      } else {
                        description = workspaceDescriptionController.text;
                      }

                      await func(name, description);
                      if (context.mounted) {
                        Navigator.pop(context);
                      }
                    },
